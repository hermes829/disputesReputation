...
karenReput2=karenReput2[,c(2:11,13,17,20)]
###############################################################
...
combData <- merge(combData, WBdbiz2[,c(3:23,ncol(WBdbiz2))],by='cyear',all.x=T,all.y=F)
unique(combData[is.na(combData$ccode), 1:5]); dim(combData)
...
unique(combData[is.na(combData$ccode), 1:5]); dim(combData)
combData <- merge(combData, karenReput2,by='cyear',all.x=T,all.y=F)
unique(combData[is.na(combData$ccode), 1:5]); dim(combData)
