...
\begin{figure}[ht]
	\centering
	\caption{Correlation Between Log(FDI) and Lagged Disputes by Country}
	\label{fig:corrFDI}
	\includegraphics[width=1\textwidth]{graphics/corrFDI.pdf}
	\caption*{Note: Here we show the correlation coefficients between our dispute variables and logged FDI flows for each country with at least one dispute recorded from 1986 to 2014.}
\end{figure}
\FloatBarrier
