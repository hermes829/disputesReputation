...
\begin{figure}[ht]
	\centering
	\caption{Correlation Between FDI and Lagged Disputes by Country}
	\label{fig:corrFDI}
	\includegraphics[width=1\textwidth]{graphics/corrFDI.pdf}
	\caption*{Note: Here we show the correlation coefficients between our dispute variables and logged FDI flows for each country.}
\end{figure}
\FloatBarrier
