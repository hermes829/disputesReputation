...
In contrast to the theoretical claims developed in prior research, we argue that the reputational impact of an alleged investment treaty violations is minimal. Central characteristics of the ISDS process, particularly its narrow, decentralized, and untransparent monitoring and enforcement mechanisms, provide international investors with little to no information with which to update their perceptions of investment risk in a particular country. The extant literature has paid little attention to this issue and instead simply assumed that adverse reputational effects inevitably manifest from being brought in front of arbitration tribunals like the ICSID. Our empirical analysis shows that the reputational impact of alleged violations of international investment agreements actually do not even have a significant short-term effect on a country's reputation for the protection of investment. Further we show that even when a country is frequently brough in front of arbitration tribunals the effects on reputation are still just marginal at best.
...
% In this sense there is likely to be a marked asymmetry between the relative breadth of the signals sent out by the ex ante commitments embedded in investment treaties signed by state actors and the narrowness of the ex post monitoring, sanctioning, and enforcement mechanisms. As argued by \citeauthor{buthe:milner:2009}, BITs do not merely offer foreign investors from signatory states specific legal protections; ``Rather, BITs constitute a commitment to economically liberal policies across a broad range of issues.''\footnote{\citet{buthe:milner:2009}: 184} It is presumably for this reason that at least some prior research has found that BITs lead to a documented increase in FDI flows from both protected and unprotected investors.\footnote{\citet{kerner:2009}}
