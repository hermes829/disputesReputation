...
% , particularly since reputations are presumably not only rather sticky but also constructed around multiple observations and varied types of state-business interactions.
