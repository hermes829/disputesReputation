...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \textcolor{blue}{ \emph{ Table 3 pooled results. }}
		...
		\item \textcolor{blue}{ \emph{ Table 4 pooled results. }}
	...
	\begin{itemize}
		\item \textcolor{blue}{ \emph{ Table 2 with cumulative included in all models. }}
		...
		\item \textcolor{blue}{ \emph{ Table 4 with cumulative included in all models. }}
