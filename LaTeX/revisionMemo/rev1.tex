...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textcolor{blue}{ \emph{
		Why is the volume of claims not normalized against the volume of investment received Three reasons: a) in the interest of making scholarship cumulative, we are using the same indicators as used by those whose claims we are challenging. b) The commentator has a hypothesis that more investment means more claims, but this is merely a hypothesis and almost certainly wrong. Recipients of unusually low levels of  FDI (e.g., Moldova, and Turkmenistan) have had more disputes lodged against them (20) than four of the top five recipients of FDI (UK, Hong Kong, China, and Germany-a total of 7 disputes). c) We are interested in addressing the claims of prior research.
		}}
	\end{itemize}
	...
	\begin{itemize}
		\item \textcolor{blue}{ \emph{ We show empirically that the number of BITs ratified enhances reputation-no point in speculating to the opposite. }}
	\end{itemize}
\end{enumerate}
